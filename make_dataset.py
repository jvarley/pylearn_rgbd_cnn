...
if __name__ == "__main__":
    ...
    pipeline.items.append(
        rgbd_preprocessor.ExtractPatches(patch_shape=(60, 80), num_patches=1500)
    )
    ...
    dataset.use_design_loc(os.path.join(train_example_path, 'cnn_rgbd_preprocessed_train_design_dataset.npy'))

    train_pkl_path = os.path.join(train_example_path, 'cnn_rgbd_preprocessed_train_dataset.pkl')
